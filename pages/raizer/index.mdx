...
<Highlight 
  type="feature"
  title="Where Wall Street Meets Digital Innovation"
  description="Raizer is revolutionizing private equity by bringing it to a secure digital platform, making investing more accessible, liquid, and transparent than ever before."
/>
...
2. **Protocol Deep Dive**
   - The nuts and bolts of Raizer's platform
...
Want Raizer in a nutshell? We're a digital finance platform allowing anyone to bet on the IPO of private equity companies, making this type of investment accessible to everyone. Check out the game-changing benefits:
...
<Comparison 
  ...
  web3="Our platform creates a marketplace where you can trade your digital shares when you want"
/>

<Comparison 
  title="Transparency"
  traditional="Good luck figuring out what's happening with your PE investment"
  web3="Everything's tracked digitally - see exactly what's going on, 24/7"
/>
...
<Highlight 
  ...
  description="Automated digital systems handle the heavy lifting, making everything faster and more cost-effective."
/>

By leveraging automated systems with crystal-clear rules on our secure platform, we're automating away the bureaucracy to make investing a breeze.

<div className="mt-6">

<Feature icon={Shield}>
  **Rock-Solid Compliance**: Trade your digital shares for their right price at the IPO of the company they represent.
</Feature>

<Feature icon={Network}>
  **Interoperability**: Use your digital assets anywhere - major exchanges, trading platforms, cross-platform integration, you name it
</Feature>

<Feature icon={Users}>
  **Multi-Platform**: Digital shares from Raizer's platform are tradeable on over 100 different networks, with unified liquidity.
</Feature>
</div>
