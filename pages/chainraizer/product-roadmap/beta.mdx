...
The beta version marks ChainRaizer's transition to mainnet, featuring our first real-world private equity investment opportunity. All protocol features that were tested in alpha are now live on mainnet.

<Highlight 
  type="feature"
  title="Mainnet Launch"
  description="Experience ChainRaizer Protocol on mainnet with our inaugural private equity investment opportunity. All features are now live with real assets."
/>
...
<Highlight 
  ...
  description="Participate in our first private equity investment opportunity, showcasing the full potential of ChainRaizer Protocol in a real-world scenario."
/>
...
<Highlight 
  ...
  description="Be part of the first wave of investors using ChainRaizer Protocol to access private equity investments on the blockchain."
/> 